...
const Popup = (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", { className: "text-3xl font-bold underline text-green-500" }, "Hello world!"),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: "icon.png", alt: "" }),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { href: "about.html" }, "About")));
